			...
			<table class="table table-bordered">
				...
				<tr>
					<td>
						...
						<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">A Year With Symfony
					...
					<tr>
						<td>
							...
							<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Laravel: Code Happy
						...
						<td>
							...
							<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">.Software Architecture for Developers
						...
						<tr>
							<td>
								...
								<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Principles of Object-Oriented Programming in JavaScript</h4></a>
								<p class="text-info">
						...
						<tr>
							<td>
								...
								<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Laravel 4 Cookbook</h4></a>
								<p class="text-info">
						...
						<tr>
							<td>
								...
								<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Webentwicklung mit Zend Framework 2</h4></a>
								<p class="text-info">
									by Michael Romer</br>
						...
						<tr>
							<td>
								...
								<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Rapid Prototyping with JS
