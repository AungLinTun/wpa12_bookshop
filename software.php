			...
			<table class="table table-bordered">
				...
				<tr>
					<td>
						...
						<h4 class="text-info">A Year With Symfony
							Writing healthy, reusable Symfony2 code</h4>
							<p class="text-info">
					...
					<tr>
						<td>
							...
							<h4 class="text-info">Laravel: Code Happy
								Application development with the Laravel for beginners.</h4>
								<p class="text-info">
									by Dayle Rees</br>
						...
						<tr>
							<td>
								...
								<h4 class="text-info">.Software Architecture for Developers
									A developer-friendly guide</h4>
									<p class="text-info">
										by Simon Brown</br>
							...
							<tr>
								<td>
									...
									<h4 class="text-info">Principles of Object-Oriented Programming in JavaScript</h4>
									<p class="text-info">
							...
							<tr>
								<td>
									...
									<h4 class="text-info">Laravel 4 Cookbook</h4>
									<p class="text-info">
							...
							<tr>
								<td>
									...
									<h4 class="text-info">Webentwicklung mit Zend Framework 2</h4>
									<p class="text-info">
										by Michael Romer</br>
							...
							<tr>
								<td>
									...
									<h4 class="text-info">Rapid Prototyping with JS
										Agile JavaScript Development </h4>
										<p class="text-info">
											by Azat Mardanov</br>
											List Price <strike>$39.08</strike>
											Our Price 36.02 </br>
