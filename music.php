...
<div class="col-md-8">
	<table class="table table-bordered">
		<tr class="info">
			...
			<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">How to build a Home Entertainment Personal Computer</h4></a>
			<p class="text-info">
			by Sandeep Giri</br>
		...
		<tr>
			...
			<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Prepare, Produce, Publish
		...
		<tr>
			...
			<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Playing The Native American Flute</h4></a>
			<p class="text-info">
			by Lee Miles</br>
		...
		<tr>
			...
			<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Le Guide Ultime et Zen de Max for Live</h4></a>
			<p class="text-info">
			by Julien Bayle</br>
			List Price <strike>$37.99</strike>
			Our Price $35.12 </br>
