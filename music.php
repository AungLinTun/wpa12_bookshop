...
<body>
			    ...
			    <div class="col-md-8">
				  ...
				  by Sandeep Giri</br>
				   ...
				   <h4 class="text-info">Prepare, Produce, Publish
				   Your First Podcast, In 3 Easy Steps!</h4>
				   <p class="text-info">
				 by Derick Bailey</br>
				   ...
				   <h4 class="text-info">Playing The Native American Flute</h4>
				   <p class="text-info">
				   by Lee Miles</br>
				   ...
				   <h4 class="text-info">Le Guide Ultime et Zen de Max for Live</h4>
				   <p class="text-info">
				   by Julien Bayle</br>
				   List Price <strike>$37.99</strike>
				   Our Price $35.12 </br>
