			...
			<table class="table table-bordered">
				...
				<tr>
					<td>
						...
						<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Sometimes We Ran-A Story From the Zombie Apocalypse</h4></a>
						<p class="text-info">
				...
				<tr>
					<td>
						...
						<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Sometimes We Ran2-Community</h4></a>
						<p class="text-info">
							by Stephen Drivick</br>
				...
				<tr>
					<td>
						...
						<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">''Neden korktuğuna dikkat et...''</h4></a>
						<p class="text-info">
							by C.C.DENGİZ</br>
							List Price <strike>$37.99</strike>
							Our Price $35.12 </br>
				...
				<tr>
					<td>
						...
						<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Rose in Ice</h4>
					...
					<tr>
						<td>
							...
							<a href="http://localhost/bookshop/detail.php"><h4 class="text-info">Senate of Blood
