		...
		<div class="col-md-10">
			...
			<tr>
				<td>
					...
					<h4 class="text-info">''Neden korktuğuna dikkat et...''</h4>
					<p class="text-info">
						by C.C.DENGİZ</br>
			...
			<tr>
				<td>
					...
					<h4 class="text-info">Sometimes We Ran-A Story From the Zombie Apocalypse</h4>
					<p class="text-info">
			...
			<tr>
				<td>
					...
					<h4 class="text-info">Sometimes We Ran2-Community</h4>
					<p class="text-info">
						by Stephen Drivick</br>
			...
			<tr>
				<td>
					...
					<h4 class="text-info">How to build a Home Entertainment Personal Computer</h4>
					<p class="text-info">
						by Sandeep Giri</br>
